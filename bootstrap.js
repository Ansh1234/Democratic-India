...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Hackathon.controller.Attend": [],
  "Hackathon.controller.Main": [],
  "Hackathon.controller.PopularPosts": [],
  "Hackathon.model.DiscussionForum": [],
  "Hackathon.model.Karnataka": [],
  "Hackathon.model.MadhyaPradesh": [],
  "Hackathon.model.News": [],
  "Hackathon.model.PrePollsLeftMenu": [],
  "Hackathon.model.Punjab": [],
  "Hackathon.model.Rajasthan": [],
  "Hackathon.model.States": [],
  "Hackathon.store.DiscussionForum": [],
  "Hackathon.store.Karnataka": [],
  "Hackathon.store.MadhyaPradesh": [],
  "Hackathon.store.News": [],
  "Hackathon.store.PrePollsLeftMenu": [],
  "Hackathon.store.Punjab": [],
  "Hackathon.store.Rajasthan": [],
  "Hackathon.store.States": [],
  "Hackathon.view.Candidate1": [],
  "Hackathon.view.Candidate2": [],
  "Hackathon.view.Candidate3": [],
  "Hackathon.view.Candidates": [],
  "Hackathon.view.Discussion1": [],
  "Hackathon.view.DiscussionForum": [],
  "Hackathon.view.Forum_Discussion": [],
  "Hackathon.view.HomePage": [],
  "Hackathon.view.Letter1": [],
  "Hackathon.view.Letter2": [],
  "Hackathon.view.Letter3": [],
  "Hackathon.view.Letters": [],
  "Hackathon.view.Login": [],
  "Hackathon.view.LowerHalf": [],
  "Hackathon.view.Main": [],
  "Hackathon.view.Manifesto1": [],
  "Hackathon.view.Manifestos": [],
  "Hackathon.view.MeetUp": [],
  "Hackathon.view.MeetUp1": [],
  "Hackathon.view.MeetUp2": [],
  "Hackathon.view.MeetUp3": [],
  "Hackathon.view.MeetUp4": [],
  "Hackathon.view.MeetUp5": [],
  "Hackathon.view.MeetUp6": [],
  "Hackathon.view.MeetUps": [],
  "Hackathon.view.News1": [],
  "Hackathon.view.OpinionPolls": [],
  "Hackathon.view.OpinionPolls1": [],
  "Hackathon.view.OpinionPolls2": [],
  "Hackathon.view.OpinionPolls3": [],
  "Hackathon.view.OpinionPolls4": [],
  "Hackathon.view.OpinionPolls5": [],
  "Hackathon.view.PopularPosts": [],
  "Hackathon.view.PrePollsLeftMenu": [],
  "Hackathon.view.PrePollsRightMenu": [],
  "Hackathon.view.RecentPosts": [],
  "Hackathon.view.Register": [],
  "Hackathon.view.UpperHalf": [],
  "Hackathon.view.Video1": [],
  "Hackathon.view.Video2": [],
  "Hackathon.view.Video3": [],
  "Hackathon.view.Videos": [],
  "Hackathon.view.WriteaPost": [],
  "Hackathon.view.right": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "Hackathon.view.OpinionPolls1": [
    "widget.opinionpolls1"
  ],
  "Hackathon.view.OpinionPolls2": [
    "widget.opinionpolls2"
  ],
  "Hackathon.view.OpinionPolls3": [
    "widget.opinionpolls3"
  ],
  "Hackathon.view.OpinionPolls4": [
    "widget.opinionpolls4"
  ],
  "Hackathon.view.OpinionPolls5": [
    "widget.opinionpolls5"
  ],
  "Hackathon.view.PopularPosts": [
    "widget.popularposts"
  ],
  "Hackathon.view.PrePollsLeftMenu": [
    "widget.prepollsleftmenu"
  ],
  "Hackathon.view.PrePollsRightMenu": [
    "widget.prepollsrightmenu"
  ],
  "Hackathon.view.RecentPosts": [
    "widget.recentposts"
  ],
